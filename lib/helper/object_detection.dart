...
class ObjectDetection {
  static const String _modelPath = 'assets/ssd_mobilenet_v1_1_metadata_1.tflite';
  static const String _labelPath = 'assets/mobilenet.txt';
  ...
  List<List<Object>> _runInference(
    ...
    final expectedinput = _interpreter!.getInputTensors().first;
    final expectedoutput = _interpreter!.getOutputTensors().first;
    final output = {
    ...
    // _interpreter!.runForMultipleInputs([input], expectedoutput);
